...
def main():
    ...
    os.environ["APPLE_PLATFORM"] = os.environ.get("APPLE_PLATFORM", "OS64")
    os.environ["APPLE_ABI"] = os.environ.get("APPLE_ABI", "arm64")
    os.environ["APPLE_VER"] = os.environ.get("APPLE_VER", "15.0")
    ...
    os.environ["VCPKG_TARGET_TRIPLET"] = os.environ.get("VCPKG_TARGET_TRIPLET", f"{os.environ['APPLE_ABI']}-ios")
