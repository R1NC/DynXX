...
function(dynxx_print_summary TARGET_NAME LINK_LIBS_VAR SANITIZERS_VAR)
    ...
    message(" └─ OPTIONS:")
    message("     └─ USE_STD_TO_CHARS: ${DYNXX_USE_STD_TO_CHARS}")
    message("     └─ USE_CURL: ${DYNXX_USE_CURL}")
    message("     └─ USE_LUA: ${DYNXX_USE_LUA}")
    message("     └─ USE_QJS: ${DYNXX_USE_QJS}")
    message("     └─ USE_KV: ${DYNXX_USE_KV}")
    message("     └─ USE_DB: ${DYNXX_USE_DB}")
    message("     └─ USE_DEVICE: ${DYNXX_USE_DEVICE}")
    message("     └─ USE_LIBUV: ${DYNXX_USE_LIBUV}")
    message("     └─ USE_SPDLOG: ${DYNXX_USE_SPDLOG}")
    message("     └─ USE_ADA: ${DYNXX_USE_ADA}")
    message(" └─ LINK_LIBS:")
