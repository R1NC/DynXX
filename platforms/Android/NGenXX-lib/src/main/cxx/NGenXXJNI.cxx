...
const JNINativeMethod JCFuncList[] = {
    DECLARE_JNI_FUNC("getVersion", "()" LJLS_ "", getVersion),
    DECLARE_JNI_FUNC("init", "(" LJLS_ ")Z", init),
    DECLARE_JNI_FUNC("release", "()V", release),

    DECLARE_JNI_FUNC("logSetLevel", "(I)V", logSetLevel),
    DECLARE_JNI_FUNC("logSetCallback", "(" LKF2_ ")V", logSetCallback),
    DECLARE_JNI_FUNC("logPrint", "(I" LJLS_ ")V", logPrint),

    DECLARE_JNI_FUNC("netHttpRequest", "(" LJLS_ "" LJLS_ "I[" LJLS_ "[" LJLS_ "[" LJLS_ "[" LJLS_ "" LJLS_ "JJ)" LJLS_ "", netHttpRequest),

    DECLARE_JNI_FUNC("lLoadF", "(" LJLS_ ")Z", lLoadF),
    DECLARE_JNI_FUNC("lLoadS", "(" LJLS_ ")Z", lLoadS),
    DECLARE_JNI_FUNC("lCall", "(" LJLS_ "" LJLS_ ")" LJLS_ "", lCall),

    DECLARE_JNI_FUNC("jLoadF", "(" LJLS_ "Z)Z", jLoadF),
    DECLARE_JNI_FUNC("jLoadS", "(" LJLS_ "" LJLS_ "Z)Z", jLoadS),
    DECLARE_JNI_FUNC("jLoadB", "([BZ)Z", jLoadB),
    DECLARE_JNI_FUNC("jCall", "(" LJLS_ "" LJLS_ "Z)" LJLS_ "", jCall),
    DECLARE_JNI_FUNC("jSetMsgCallback", "(" LKF1_ ")V", jSetMsgCallback),

    DECLARE_JNI_FUNC("storeSQLiteOpen", "(" LJLS_ ")J", storeSQLiteOpen),
    DECLARE_JNI_FUNC("storeSQLiteExecute", "(J" LJLS_ ")Z", storeSQLiteExecute),
    DECLARE_JNI_FUNC("storeSQLiteQueryDo", "(J" LJLS_ ")J", storeSQLiteQueryDo),
    DECLARE_JNI_FUNC("storeSQLiteQueryReadRow", "(J)Z", storeSQLiteQueryReadRow),
    DECLARE_JNI_FUNC("storeSQLiteQueryReadColumnText", "(J" LJLS_ ")" LJLS_ "", storeSQLiteQueryReadColumnText),
    DECLARE_JNI_FUNC("storeSQLiteQueryReadColumnInteger", "(J" LJLS_ ")J", storeSQLiteQueryReadColumnInteger),
    DECLARE_JNI_FUNC("storeSQLiteQueryReadColumnFloat", "(J" LJLS_ ")D", storeSQLiteQueryReadColumnFloat),
    DECLARE_JNI_FUNC("storeSQLiteQueryDrop", "(J)V", storeSQLiteQueryDrop),
    DECLARE_JNI_FUNC("storeSQLiteClose", "(J)V", storeSQLiteClose),

    DECLARE_JNI_FUNC("storeKVOpen", "(" LJLS_ ")J", storeKVOpen),
    DECLARE_JNI_FUNC("storeKVReadString", "(J" LJLS_ ")" LJLS_ "", storeKVReadString),
    DECLARE_JNI_FUNC("storeKVWriteString", "(J" LJLS_ "" LJLS_ ")Z", storeKVWriteString),
    DECLARE_JNI_FUNC("storeKVReadInteger", "(J" LJLS_ ")J", storeKVReadInteger),
    DECLARE_JNI_FUNC("storeKVWriteInteger", "(J" LJLS_ "J)Z", storeKVWriteInteger),
    DECLARE_JNI_FUNC("storeKVReadFloat", "(J" LJLS_ ")D", storeKVReadFloat),
    DECLARE_JNI_FUNC("storeKVWriteFloat", "(J" LJLS_ "D)Z", storeKVWriteFloat),
    DECLARE_JNI_FUNC("storeKVContains", "(J" LJLS_ ")Z", storeKVContains),
    DECLARE_JNI_FUNC("storeKVRemove", "(J" LJLS_ ")Z", storeKVRemove),
    DECLARE_JNI_FUNC("storeKVClear", "(J)V", storeKVClear),
    DECLARE_JNI_FUNC("storeKVClose", "(J)V", storeKVClose),

    DECLARE_JNI_FUNC("deviceType", "()I", deviceType),
    DECLARE_JNI_FUNC("deviceName", "()" LJLS_ "", deviceName),
    DECLARE_JNI_FUNC("deviceManufacturer", "()" LJLS_ "", deviceManufacturer),
    DECLARE_JNI_FUNC("deviceOsVersion", "()" LJLS_ "", deviceOsVersion),
    DECLARE_JNI_FUNC("deviceCpuArch", "()I", deviceCpuArch),

    DECLARE_JNI_FUNC("codingHexBytes2Str", "([B)" LJLS_ "", codingHexBytes2Str),
    DECLARE_JNI_FUNC("codingHexStr2Bytes", "(" LJLS_ ")[B", codingHexStr2Bytes),

    DECLARE_JNI_FUNC("cryptoRandom", "(I)[B", cryptoRandom),
    DECLARE_JNI_FUNC("cryptoAesEncrypt", "([B[B)[B", cryptoAesEncrypt),
    DECLARE_JNI_FUNC("cryptoAesDecrypt", "([B[B)[B", cryptoAesDecrypt),
    DECLARE_JNI_FUNC("cryptoAesGcmEncrypt", "([B[B[B[BI)[B", cryptoAesGcmEncrypt),
    DECLARE_JNI_FUNC("cryptoAesGcmDecrypt", "([B[B[B[BI)[B", cryptoAesGcmDecrypt),
    DECLARE_JNI_FUNC("cryptoHashMd5", "([B)[B", cryptoHashMd5),
    DECLARE_JNI_FUNC("cryptoHashSha256", "([B)[B", cryptoHashSha256),
    DECLARE_JNI_FUNC("cryptoBase64Encode", "([B)[B", cryptoBase64Encode),
    DECLARE_JNI_FUNC("cryptoBase64Decode", "([B)[B", cryptoBase64Decode),

    DECLARE_JNI_FUNC("jsonReadType", "(J)I", jsonReadType),
    DECLARE_JNI_FUNC("jsonDecoderInit", "(" LJLS_ ")J", jsonDecoderInit),
    DECLARE_JNI_FUNC("jsonDecoderReadNode", "(JJ" LJLS_ ")J", jsonDecoderReadNode),
    DECLARE_JNI_FUNC("jsonDecoderReadString", "(JJ)" LJLS_ "", jsonDecoderReadString),
    DECLARE_JNI_FUNC("jsonDecoderReadNumber", "(JJ)D", jsonDecoderReadNumber),
    DECLARE_JNI_FUNC("jsonDecoderReadChild", "(JJ)J", jsonDecoderReadChild),
    DECLARE_JNI_FUNC("jsonDecoderReadNext", "(JJ)J", jsonDecoderReadNext),
    DECLARE_JNI_FUNC("jsonDecoderRelease", "(J)V", jsonDecoderRelease),

    DECLARE_JNI_FUNC("zZipInit", "(IJI)J", zZipInit),
    DECLARE_JNI_FUNC("zZipInput", "(J[BIZ)J", zZipInput),
    DECLARE_JNI_FUNC("zZipProcessDo", "(J)[B", zZipProcessDo),
    DECLARE_JNI_FUNC("zZipProcessFinished", "(J)Z", zZipProcessFinished),
    DECLARE_JNI_FUNC("zZipRelease", "(J)V", zZipRelease),
    DECLARE_JNI_FUNC("zUnZipInit", "(JI)J", zUnZipInit),
    DECLARE_JNI_FUNC("zUnZipInput", "(J[BIZ)J", zUnZipInput),
    DECLARE_JNI_FUNC("zUnZipProcessDo", "(J)[B", zUnZipProcessDo),
    DECLARE_JNI_FUNC("zUnZipProcessFinished", "(J)Z", zUnZipProcessFinished),
    DECLARE_JNI_FUNC("zUnZipRelease", "(J)V", zUnZipRelease),
    DECLARE_JNI_FUNC("zZipBytes", "(IJI[B)[B", zZipBytes),
    DECLARE_JNI_FUNC("zUnZipBytes", "(JI[B)[B", zUnZipBytes),
};
