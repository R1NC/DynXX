...
enum DynXXCryptoRSAPadding {
    DynXXCryptoRSAPaddingPKCS1 = 1,
    DynXXCryptoRSAPaddingSSLV23 = 2,
    DynXXCryptoRSAPaddingNO = 3,
    DynXXCryptoRSAPaddingPKCS1_OAEP = 4,
    DynXXCryptoRSAPaddingX931 = 5,
    DynXXCryptoRSAPaddingPKCS1_PSS = 6
};
 ...
 * @param padding see `DynXXCryptoRSAPadding`
 * @param outLen a pointer to read output bytes length
