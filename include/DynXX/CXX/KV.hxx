...
[[nodiscard]] bool dynxxKVWriteString(DynXXKVConnHandle conn, std::string_view k, const std::string &v);

std::optional<int64_t> dynxxKVReadInteger(DynXXKVConnHandle conn, std::string_view k);

[[nodiscard]] bool dynxxKVWriteInteger(DynXXKVConnHandle conn, std::string_view k, int64_t v);

std::optional<double> dynxxKVReadFloat(DynXXKVConnHandle conn, std::string_view k);

[[nodiscard]] bool dynxxKVWriteFloat(DynXXKVConnHandle conn, std::string_view k, double v);

std::vector<std::string> dynxxKVAllKeys(DynXXKVConnHandle conn);

bool dynxxKVContains(DynXXKVConnHandle conn, std::string_view k);

[[nodiscard]] bool dynxxKVRemove(DynXXKVConnHandle conn, std::string_view k);
